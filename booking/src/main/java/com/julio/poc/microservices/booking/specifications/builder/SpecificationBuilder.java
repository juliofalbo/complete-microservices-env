package com.julio.poc.microservices.booking.specifications.builder;
...
import com.julio.poc.microservices.booking.specifications.CustomSpecification;
import com.julio.poc.microservices.booking.specifications.domain.SpecificationFilter;
import com.julio.poc.microservices.booking.specifications.domain.FieldIn;
import com.julio.poc.microservices.booking.specifications.enums.SpecificationOperationEnum;
...
public class SpecificationBuilder {
    ...
    public SpecificationBuilder withInFilter(FieldIn inField, Object value) {
        addFilterIfValueIsNotNull(inField, value);
        return this;
    }
    ...
    public <T> Specification<T> buildSpec() {
        ...
        filters.forEach(filter -> searchSpec.set(searchSpec.get().and(new CustomSpecification<T>(filter))));
    ...
    private void addFilterIfValueIsNotNull(FieldIn fieldIn, Object value) {
        if (value != null) {
            SpecificationFilter fieldSpec = new SpecificationFilter(fieldIn, value, SpecificationOperationEnum.IN);
            this.filters.add(fieldSpec);
        }
    }
